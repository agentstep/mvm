...
func (s *Server) buildMux() *http.ServeMux {
	...
	register("POST", "/vms/{name}/bounce", s.handleBounce)
	register("GET", "/vms/{name}/services", s.handleServiceList)
	register("POST", "/vms/{name}/services", s.handleServiceAdd)
	register("DELETE", "/vms/{name}/services/{service}", s.handleServiceDelete)
	register("POST", "/vms/{name}/services/{service}/restart", s.handleServiceRestart)
	register("GET", "/vms/{name}/services/{service}/logs", s.handleServiceLogs)
